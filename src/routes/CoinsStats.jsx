         ...
         <div className="secondTitle__section">
           <div className="mobilePage">
             ...
             <p className="subTitle">
               CryptoCheck delivers live cryptocurrency tracking, market
               analysis, and expert insights in one convenient platform. Whether
               you're a seasoned trader or a crypto enthusiast, stay informed
               with real-time data, price updates, and trends to make smarter
               decisions in the fast-evolving world of digital currencies. You
               can also switch to your preferred currency and access a converter
               for your chosen coin by simply clicking the 'more info' button.
               Enjoy!
             </p>
